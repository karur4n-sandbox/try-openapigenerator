...
class Pet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling Pet., must be bigger than or equal to 1.');
        }
     ...
     * Sets category
     *
     * @param \OpenAPI\Client\Model\Category $category カテゴリー
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param \OpenAPI\Client\Model\Tag[] $tags タグ
     *
     * @return self
     */
