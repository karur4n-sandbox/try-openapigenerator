...
/**
 * ChatRoomListUser Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ChatRoomListUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChatRoomList_User';
    ...
    */
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\ChatRoomListUserStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\ChatRoomListUserStatus $status status
     *
     * @return self
     */
